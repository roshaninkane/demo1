...
public class ReadThaDataXml
{
@DataProvider
private String [ ][] createuser() throws Exception
{
	String [][] s;
	String path ="./Data/datadata.xlsx";
	
	Workbook execel =WorkbookFactory.create(new FileInputStream(path));
	Sheet sheet=execel.getSheet("sheet1");
